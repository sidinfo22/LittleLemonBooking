...
export default function BookingForm({availableTimes, dispatch, submitForm}) {
    ...
    return (
      <main>
        <p className="form-title">Please fill in the form below accurately to enable us serve you.</p>
        <form onSubmit={handleSubmit} className="form">
          ...
          <input className="primary-btn" type="submit" value="Reserve" aria-label="submit button"/>
      </form>
      </main>
    )
  }
